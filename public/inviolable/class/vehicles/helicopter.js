...
export default class extends Vehicle {
    ...
    drawCockpit(self = this) {
        ...
        c.closePath(),
        c.restore(),
        c.fillStyle = window.inviolable.storage.get("dark") ? "#fff" : "#000",
        c.fill(),
        c.lineWidth = l,
        c.strokeStyle = window.inviolable.storage.get("dark") ? "#fff" : "#000",
        c.stroke(),
        c.save(),
        c.translate(r / 2, o / 2),
        c.scale(1.3, 1),
    ...
    draw(self = this, alpha) {
        if (this.explosion)
            ...
            self.rotor = n,
            self.rotor2 = r,
            t.strokeStyle = window.inviolable.storage.get("dark") ? "#fff" : "#000",
            t.lineWidth = 5 * a,
            t.beginPath(),
