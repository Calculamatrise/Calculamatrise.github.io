...
export default class extends Vehicle {
    ...
    drawBikeFrame(self = this, alpha = this.player._opacity) {
        ...
        u.globalAlpha = r,
        u.strokeStyle = window.inviolable.storage.get("cc") || (window.inviolable.storage.get("dark") ? "#FBFBFB" : "#000000"),
        u.lineWidth = 3 * c,
        u.lineCap = "round",
        u.lineJoin = "round",
        u.beginPath(),
        ...
        u.lineTo(P.x, P.y),
        u.stroke(),
        u.strokeStyle = window.inviolable.storage.get("dark") ? "#FBFBFB" : "#000000";
        if (self.crashed) {
            ...
            u.strokeStyle = window.inviolable.storage.get("dark") ? "#fdfdfda5" : "#000000a5",
            u.lineWidth = 6 * c,
            u.beginPath(),
            u.moveTo(y.x, y.y),
            u.lineTo(O.x, O.y),
            ...
            u.lineTo(P.x, P.y),
            u.stroke();
            var R = GameInventoryManager.getItem(window.inviolable.storage.get("cr") ? window.inviolable.head : this.cosmetics.head);
