...
export default class {
    ...
    draw() {
        ...
        ctx.lineCap = "round",
        ctx.strokeStyle = lite.storage.get("dark") ? "#707070" : this.settings.sceneryLineColor,
        this.drawLines(this.sceneryLines, this.scene.camera.zoom, ctx),
        ctx.stroke(),
        ctx.beginPath(),
        ctx.strokeStyle = lite.storage.get("dark") ? "#FBFBFB" : this.settings.physicsLineColor,
